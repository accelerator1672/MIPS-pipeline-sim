...
typedef struct CPU_State_Struct {
	...
	uint32_t PIPE_START[PIPE_STAGE];

	//IF_ID_latch
	uint32_t IF_ID_INST;
	uint32_t IF_ID_NPC;
	unsigned char IF_ID_NOOP;
	...
	//Forwarding
	unsigned char EX_MEM_FORWARD_REG1;
	unsigned char EX_MEM_FORWARD_REG2;
	unsigned char MEM_WB_FORWARD_REG1;
	unsigned char MEM_WB_FORWARD_REG2;
	uint32_t EX_MEM_FORWARD_VALUE1;
	uint32_t EX_MEM_FORWARD_VALUE2;
